...
import { fetchCart, updateCart } from "../../fetchAPI/fetchCart";
import { fetchProducts } from "../../fetchAPI/fetchProduct";
    ...
    useEffect(() => {
        const getProducts = async () => {
            try {
                ...
                setIsProductsLoaded(true); // Đặt cờ thành true khi hoàn tất tải sản phẩm
            } catch (error) {
                console.error("Error fetching products:", error);
            }
        };
    
        getProducts(); // Chỉ gọi hàm khi sản phẩm chưa được tải
    }, [isProductsLoaded]);
