                ...
                >
                  ...
                  <div className="flex flex-col sm:flex-row gap-4 mt-4">
                    ...
                    <div className="flex-[5] p-4 bg-gray-50 rounded-lg border border-gray-200">
                      ...
                      <p>
                        <strong>Số điện thoại:</strong> {order.deliveryAddress.phone}
                      </p>
                      <p>
                    ...
                    <div className="flex-[2] p-4 bg-gray-50 rounded-lg border border-gray-200">
                      ...
                      <p>
                        <strong>Ngày nhận thực tế:</strong> {(order.deliveryDate)}
                      </p>
                    </div>

                    {/* Tổng tiền và thông tin bổ sung */}
                    <div className="flex-[2] p-4 bg-gray-50 rounded-lg border border-gray-200">
                      <h3 className="font-semibold text-lg mb-2">Thông tin đơn hàng</h3>
                      <p>
                        <strong>Tiền ship:</strong> {formatCurrency(Number(order.shipping_fee))}
                      </p>
                      <p>
                        <strong>Tổng tiền:</strong> {formatCurrency(Number(order.price))}
                      </p>
                      <p>
