...
public class BuyerController {
	...
	public ResponseAPITemplate<BuyerInformationResopnse> getInfo(
	...
	public ResponseAPITemplate<CreateOrderResponse> updateStateOfOrder(
	...
	@PostMapping("/review")
	public ResponseAPITemplate<ReviewResponse> reviewProduct(
			@AuthenticationPrincipal Jwt jwt,
	...
	@GetMapping("/review")
	public ResponseAPITemplate<ReviewProductInstanceResponse> getAllProductInstanceToReview(
			@AuthenticationPrincipal Jwt jwt
	) {
		String username = jwt.getSubject();
	...
	@PostMapping("/follow")
	public ResponseAPITemplate<FollowResponse> followSeller(
			@AuthenticationPrincipal Jwt jwt,
	...
	public ResponseAPITemplate<FollowResponse> unFollowSeller(
			@AuthenticationPrincipal Jwt jwt,
			@RequestParam String sellerUsername
	) {
	...
	public ResponseAPITemplate<PaymentInfoResponse> addPaymentInfo(
			@AuthenticationPrincipal Jwt jwt,
			@RequestBody AddPaymentInfoRequest addPaymentInfoRequest
	) {
	...
	public ResponseAPITemplate<PaymentInfoResponse> deletePaymentInfo(
			@AuthenticationPrincipal Jwt jwt,
