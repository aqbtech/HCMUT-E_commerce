...
public class CartController {
	...
	public ResponseAPITemplate<String> addProductInstanceToCart(
			@AuthenticationPrincipal Jwt jwt,
	...
	public ResponseAPITemplate<String> removeProductInstanceFromCart(
			@AuthenticationPrincipal Jwt jwt,
			@RequestParam(value = "productInstanceId") String productInstanceId
	) {
		String username = jwt.getSubject();
	...
	public ResponseAPITemplate<String> updateProductInstanceQuantity(
			@AuthenticationPrincipal Jwt jwt,
			@RequestParam(value = "productInstanceId") String productInstanceId,
			@RequestParam(value = "quantity") Long quantity
	) {
